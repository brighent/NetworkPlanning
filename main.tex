...
\end{equation}
where $\tilde{y}_i$, $i=1, \ldots, S$, is the soft output corresponding the $i^{\rm th}$  training point and $p_t$ is the \ac{pmd} of label $t$. \hl{This is due to the fact that we can interpret $\tilde{y}$ as $p(\mathcal{H}_0|\bm y)$, as wil be later discussed}.
