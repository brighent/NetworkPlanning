...
%  \begin{figure}[h]
%      \centering
%      \includegraphics[width=0.9\columnwidth]{5bs.eps}
%      \caption{\ac{irlv} deployment scenario. $N_{\rm AP}=5$ \acp{bs} are located in the streets separating 4 buildings. The \ac{roi} is represented by the lower-left building.}
%      \label{fig:5bs}
%  \end{figure}
